            ...
            <div className="col-12">
              <div className="heading-section  text-center mb-48">
                <h2 className="title text_white split-text effect-right">
                  <SplitTextAnimation text="Promociones" />
                </h2>
                <p
                  className="text-1 text_white wow animate__fadeInUp animate__animated"
                  data-wow-duration="1.5s"
                >
                  Estamos en celebración y queremos recompensarte con algunos de estos premios
                </p>
              </div>
              <BrandSlider />
            </div>
              ...
              <div className="content">
                <div className="heading-section mb-30">
                  <h2 className="title split-text effect-right">
                    <SplitTextAnimation text="¿Que esta esperando?" />
                    <br />
                    <SplitTextAnimation text="Participa y ganemos juntos" />
                  </h2>
                  <p
                    className="text-1 split-text split-lines-transform"
                    data-wow-duration="1.5s"
                  >
                    Es tan fácil como comprar tu ticket y esperar al día de la premiación !Más fácil imposible¡
                  </p>
                </div>
